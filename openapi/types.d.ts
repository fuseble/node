...
export declare type ControllerAPIResponseSchema<T = object> = {
  key: keyof T | string;
...
export declare type ValidatorKey = 'param' | 'params' | 'query' | 'header' | 'body';
export declare type ValidationItemType = 'string' | 'number' | 'boolean' | 'any' | 'array' | 'object' | 'file' | 'none';
